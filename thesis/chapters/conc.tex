...
to evaluate performance. The methodologies were implemented and illustrated using real financial data, with code provided to promote full
reproducibility.
\newpage
