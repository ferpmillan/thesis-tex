...
\begin{figure}[H]
   ...
   \caption{25-Day rolling correlation of standardized returns (training period).}
    \label{5.1}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.18]{../../plots/5.2.png} % Replace 
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.17]{../../plots/5.3.png} % Replace 
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.17]{../../plots/5.4.png} % Replace 
