...
to evaluate performance. The methodologies were implemented and illustrated using real financial data, with all \Rlogo\ code made openly available in the accompanying GitHub repository (\href{https://github.com/ferpmillan/thesis}{github.com/ferpmillan/thesis}) to promote full
reproducibility.
