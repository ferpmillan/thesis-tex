...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.18]{../../plots/4.1.png} % Replace 
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.18]{../../plots/4.2.png} % Replace 
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.175]{../../plots/4.6.png} % Replace 
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.13]{../../plots/4.7.png} % Replace 
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.13]{../../plots/4.8.png} % Replace 
...
where $\bar{d}$ is the average difference in log-likelihood scores, $d_t = \ell^{\text{(GARCH)}}(R_{t+1}|F_{t}) - \ell^{\text{(GJR)}}(R_{t+1}|F_{t})$, with $\ell^{(m)}(\cdot)$ and $\ell^{(n)}(\cdot)$ representing the log-likelihoods of the two competing models. Here, $\hat{\sigma}_d$ denotes the standard deviation of the series $\{d_t\}$, and $T$ is the sample size. Under the null hypothesis of equal forecast accuracy, the DM statistic follows a standard normal distribution. 
